...
class BottomLineRule extends BaseRule {
  ...
  isValidClaim(ticket, announcedNumbers) {
    ...
    return areAllNumbersAnnounced(line, announcedNumbers) && isLastNumberValid(line, announcedNumbers);
  }
}

module.exports = BottomLineRule;
